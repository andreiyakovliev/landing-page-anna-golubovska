(() => {
    ...
    function hideButton() {
        ...
        if (uniqueElement) window.addEventListener("scroll", (() => {
            ...
            if (windowWidth > burgerMenuWidth) if (lastBlockPosition.bottom < windowPosition) pageButton.style.display = "block"; else pageButton.style.display = "none"; else pageButton.style.display = "none";
        }));
    }
    hideButton();
    window["FLS"] = true;
